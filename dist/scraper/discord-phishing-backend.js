...
const requestPool = new undici_1.Pool('https://raw.githubusercontent.com');
exports.default = async () => {
    try {
        ...
        await (0, database_1.set)('links:phamleduy04', JSON.stringify(links));
        ...
        await (0, database_1.set)('domains:phamleduy04', JSON.stringify(domains));
...
//# sourceMappingURL=discord-phishing-backend.js.map