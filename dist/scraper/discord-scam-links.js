...
exports.default = async () => {
    try {
        const blacklist = await (0, undici_1.request)(url).then(res => res.body.text());
        await (0, database_1.set)('domains:buildbot42', JSON.stringify(blacklist.split('\n').filter(el => !el.includes('/') && el.length)));
...
//# sourceMappingURL=discord-scam-links.js.map