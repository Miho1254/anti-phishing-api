...
exports.default = async () => {
    try {
        ...
        await (0, database_1.set)('domains:nikolaischunk', JSON.stringify(blacklist.domains.filter(el => !el.includes('/') && el.length)));
        await (0, database_1.set)('links:nikolaischunk', JSON.stringify(blacklist.domains.filter(el => el.includes('/') && el.length)));
...
//# sourceMappingURL=discord-phishing-links.js.map